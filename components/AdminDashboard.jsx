...
import { Users, Key, Shield, LogOut, UserPlus, Code, Plus, Calculator, Send, LoaderCircle as Loader2, UtensilsCrossed, Bot, Dumbbell, Apple, Target, Trophy, Camera as CameraIcon, Eye, TrendingUp, Settings, ChevronDown, Link, FileCheck, MessageSquare, Trash2, Search, Flame, Clock, Pencil as Edit2, Mic, ChefHat, Sparkles } from 'lucide-react'
        ...
        <DialogContent className="bg-[#1a1a1a] border-violet-500/20 text-white max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Edita las macros y las comidas sugeridas por el sistema antes de enviarlas y asignarlas al socio.
            </DialogDescription>
          </DialogHeader>
