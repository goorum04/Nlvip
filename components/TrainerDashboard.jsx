...
import {
  ...
  Video, Camera as CameraIcon, TrendingUp, Trash2, LoaderCircle as Loader2, Calculator, Target, Trophy, UtensilsCrossed, MessageSquare, ChefHat, Heart, Pencil as Edit
} from 'lucide-react'
            ...
            <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#151515] border-[#2a2a2a] rounded-3xl">
              <CardHeader>
                <CardTitle className="text-white flex items-center gap-2">
                  ...
                  Fotos de Progreso de Mis Socios
                </CardTitle>
              </CardHeader>
              <CardContent>
