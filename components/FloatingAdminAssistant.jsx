...
export default function FloatingAdminAssistant({ userId }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-6 left-1/2 -translate-x-1/2 lg:left-6 lg:right-auto lg:translate-x-0 w-[92%] max-w-[400px] h-[600px] max-h-[85vh] bg-[#0A0A0A] rounded-[2rem] shadow-2xl shadow-black border border-white/10 flex flex-col overflow-hidden z-50 ${isOpen ? '' : 'hidden'}`}
