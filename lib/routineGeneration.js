...
10. RUTINAS DE REHABILITACIÓN / VUELTA A LA ACTIVIDAD / ACONDICIONAMIENTO SUAVE: si el objetivo (campo "Objetivo:") contiene palabras como "rehabilitación", "rehabilitacion", "vuelta a la actividad", "acondicionamiento general", "suave", "post-hospital", "post-operatorio", "post-operatoria", "principiante absoluto", o si las "Notas adicionales" mencionan recuperación / hospital / cirugía / mucho tiempo sin entrenar, aplica:
    - 4–6 ejercicios por día (no 7-8), priorizando movimientos articulares simples y máquinas guiadas frente a peso libre.
    - Sets bajos (2–3) y reps moderadas-altas (12–15), descanso 60–90s.
    - NUNCA bi-series ni tri-series (ignora la regla 9 en este modo).
    - Evita sentadillas profundas con barra, peso muerto convencional, prensas pesadas, dominadas estrictas, fondos en paralelas y cualquier ejercicio explosivo o pliométrico — incluso si están en el catálogo.
    - Prioriza ejercicios de rango medio en máquina, movilidad controlada y trabajo de core sin compresión lumbar.
    - El "routine_name" debe reflejar el contexto (ej: "Rutina de readaptación suave", "Vuelta a la actividad", NO "Rutina de pérdida de grasa").
    - El "routine_description" debe mencionar que es una rutina progresiva de baja intensidad.
11. RANGOS POR OBJETIVO (OBLIGATORIO salvo override en notas — ver regla 12):
    Mapea el campo "Objetivo:" a estos rangos de "sets", "reps" y "rest_seconds":
    - hipertrofia / volumen / ganar músculo / ganar masa → sets: 3–4, reps: "8-12", rest_seconds: 60–90
    - fuerza → sets: 4–5, reps: "4-6", rest_seconds: 120–180
    - definición / pérdida de grasa / perder grasa / perder peso / adelgazar → sets: 3–4, reps: "10-15", rest_seconds: 45–60
    - resistencia / cardio → sets: 2–3, reps: "15-20", rest_seconds: 30–45
    - rehabilitación / acondicionamiento / vuelta a la actividad / suave → ya lo cubre la regla 10 (sets 2–3, reps 12–15, rest 60–90).
    Estos rangos son orientativos para el ejercicio principal. Para auxiliares y aislamiento puedes ir 1-2 reps por encima del rango. NO mezcles objetivos: si el goal es "hipertrofia", NO pongas un ejercicio con 20 reps salvo que sea aislamiento de pantorrilla/abdomen, y aun así no más de 1-2 ejercicios de ese tipo por día.
12. OVERRIDE POR NOTAS DEL ADMIN: si las "Notas adicionales" mencionan EXPLÍCITAMENTE un rango distinto (ej: "8 reps", "rangos de fuerza 5x5", "alto volumen 20 reps", "descanso de 2 minutos", "3 series por ejercicio"), ESE rango indicado por el admin tiene PRIORIDAD ABSOLUTA sobre la regla 11 — aplícalo. El admin sabe lo que pide.
13. AGRUPACIÓN DE GRUPOS MUSCULARES POR DÍA (split sinergista — OBLIGATORIO salvo override en notas):
    Para rutinas de hipertrofia/fuerza/definición/volumen, agrupa los días siguiendo el split sinergista clásico (entrena junto el músculo principal y su sinérgico, porque ya está pre-fatigado y "caliente"):
    - Pecho → siempre con TRÍCEPS (los tríceps son sinérgicos del press de pecho).
    - Espalda → siempre con BÍCEPS (los bíceps son sinérgicos de remos y dominadas).
    - Hombros → suelen ir aparte o con PIERNAS o CORE.
    - Piernas (cuádriceps + femoral + glúteo + gemelos) → siempre día propio.
    - Abdomen / core → al final de cualquier día.
    Plantillas por días/semana (úsalas como base, ajusta solo si las notas piden otra cosa):
    - 2 días → A: Torso (pecho+tríceps+espalda+bíceps+hombros) | B: Tren inferior + core
    - 3 días → A: Pecho+tríceps+hombros | B: Espalda+bíceps | C: Piernas+core
    - 4 días → A: Pecho+tríceps | B: Espalda+bíceps | C: Piernas+core | D: Hombros+brazos auxiliar
    - 5 días → A: Pecho+tríceps | B: Espalda+bíceps | C: Piernas | D: Hombros+core | E: Brazos+abs (o repite uno de los anteriores)
    - 6 días → PPL ×2: Push (pecho+hombros+tríceps), Pull (espalda+bíceps), Legs, Push, Pull, Legs.
    PROHIBIDO: pecho con bíceps el mismo día, espalda con tríceps el mismo día, dos días seguidos del MISMO grupo muscular grande. Esto genera fatiga incompatible y reduce gains.
    Si las "Notas adicionales" piden expresamente otro split (ej: "full-body cada día", "upper/lower", "bro-split clásico"), respétalo y omite esta regla.
...
Genera exactamente ${days_per_week} días. Responde solo con el JSON.${rationaleInstruction}`
