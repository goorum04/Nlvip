...
10. MÚSCULO REZAGADO (visible en fotos de progreso o mencionado en el historial) — DARLE FRECUENCIA 2 SIN UN DÍA DEDICADO: si el bloque de HISTORIAL Y CONTEXTO indica que un grupo o subgrupo concreto está visiblemente menos desarrollado que el resto (ej. "hombro lateral rezagado", "gemelo poco desarrollado", "hombro posterior/frontal por detrás"), NO le añadas un día entero: dale un segundo estímulo semanal metiéndolo en BI-SERIE al FINAL del último ejercicio de un día donde ya se entrene algo sinérgico o cercano a ese subgrupo. Ejemplos concretos:
