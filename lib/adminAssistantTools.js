...
export const TOOLS_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      ...
      description: "Generar una dieta COMPLETA personalizada para un socio usando el SISTEMA NL ELITE (el mismo método que el onboarding). Calcula macros precisos (TDEE = peso×24×actividad, proteína 2.4 g/kg) y genera una dieta detallada con 4 opciones por comida. El admin puede dar instrucciones adicionales en lenguaje natural: 'sin lácteos', 'le encanta el pollo', 'definición estricta', etc. Devuelve un preview; usa save_ai_diet para guardarla y asignarla.",
      parameters: {
        type: "object",
        properties: {
          member_id: {
