...
export const toolExecutors = {
  ...
  async generate_diet_plan({ member_id, goal, weight_kg }) {
    ...
    const tdee = weight * 24 // Estimación simple
    ...
    const dietPlan = `
# PROGRAMA NUTRICIONAL NL VIP
## ${profile?.name || 'Socio'} - ${goalNames[goal]}
...
### REGLAS GENERALES
• **Verdura/Ensalada:** Al gusto, con moderación
• **Aliño:** AOVE solo si se especifica. Si no: limón, especias, sal, vinagre
• **Arroces/Pastas:** Tomate tamizado (no frito)
• **Post-Entreno:** 40g proteína inmediatamente

### SUPLEMENTACIÓN
• Omega 3: 1 en desayuno
• Multivitamínico: 1 desayuno + 1 cena
• Creatina: ${Math.round(weight/10)}g diarios
• Pre-entreno: 15 min antes

### FLUIDOS
• Agua: 4-6 litros/día
• NO beber durante comidas

### COMIDA LIBRE
• 1 por semana (sustituye la comida que toque)
`
