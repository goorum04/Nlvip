...
`)
  ...
  async generate_member_routine({ member_id, goal, days_per_week = 4, level = 'intermedio', session_duration_min = 60, notes = '', allow_supersets = true, equipment = [] }) {
  ...
  async save_member_routine({ member_id, trainer_id = null, routine_data }) {
