...
/**
 * Genera un plan de dieta completo con recetas de Spoonacular + GPT.
 * Función compartida entre /api/spoonacular-diet y adminAssistantTools.
 * Se importa directamente para evitar llamadas HTTP internas (que fallan en Vercel serverless).
 */
export async function generateSpoonacularDietPlan({
  prompt,
  member_id,
  member_name,
  weight_kg = 75,
  ...
  // Interpretar el prompt con GPT para extraer restricciones concretas
