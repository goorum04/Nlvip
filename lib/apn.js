...
// Vercel escapes newlines in env vars as literal "\n". The apn library
// requires actual newline characters to parse the .p8 PEM key correctly.
const rawKey = (process.env.APNS_P8_KEY || '').replace(/\\n/g, '\n')
...
export async function sendNativeApplePush(supabase, userId, payload) {
  ...
  notification.topic = process.env.APNS_BUNDLE_ID || 'com.nlvipteam.app'
