...
Devuelve 3-6 bullets muy breves (uso interno para el entrenador, el socio nunca los ve) explicando qué cambió en la dieta y por qué, empezando cada uno con "• ". Sin título ni despedida.`
  ...
  return { adaptedContent, macros: newMacros, changeSummary, member_name: memberName }
}
...
Devuelve 2-5 bullets muy breves, en primera persona (uso interno para el entrenador, el socio nunca los ve), explicando qué cambiaste exactamente y cómo responde a su petición. Empieza cada uno con "• ". Sin título ni despedida.`
  ...
  return { content, macros: newMacros, changeSummary, explanation: explanation || changeSummary }
}
