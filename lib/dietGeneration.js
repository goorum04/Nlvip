...
const DOWN_KEYWORDS = /(definici[oó]n|definir|cutting|corte|bajar|baja|reducir|recortar|menos\s+calor|d[eé]ficit|perder\s+grasa|seguir\s+perdiendo|seguir\s+definiendo)/i
const UP_KEYWORDS = /(volumen|volumetría|bulk|subir|sube|aumentar|aumenta|m[aá]s\s+calor|super[aá]vit|ganar\s+masa|ganar\s+m[uú]sculo|seguir\s+subiendo)/i
