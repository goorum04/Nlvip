...
const schema = z.object({
  ...
  measurements: z.object({
    ...
    calvesLeft: z.number().nullable().optional(),
    calvesRight: z.number().nullable().optional(),
  }).optional().default({}),
  feeling: z.object({
  ...
  try {
    ...
    const { data: progressRecord, error: prError } = await supabase
      ...
      .insert({
        ...
        calves_cm: measurements.calves ?? measurements.calvesRight ?? measurements.calvesLeft ?? null,
        calves_left_cm: measurements.calvesLeft ?? null,
        calves_right_cm: measurements.calvesRight ?? null,
