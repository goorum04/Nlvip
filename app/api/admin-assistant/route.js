...
- set_routine_dropset: "ponle un dropset al press banca", "haz dropset las curls del día 4", "añade dropset de 3 al jalón", "quita el dropset del press" → marca o desmarca un ejercicio como dropset. Si el admin no especifica cuántos drops, usa 2 por defecto. Para QUITAR un dropset, llama con drops=0.
  ...
  try {
    ...
    if (toolCalls.length > 0) {
      const readOnlyTools = [
        ...
        'modify_routine_exercise', 'modify_routine_day', 'set_routine_dropset'
      ]
      const autoExecute = []
